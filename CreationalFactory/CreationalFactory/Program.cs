...
namespace CreationalFactory
{
    class Program
    {
        static void Main(string[] args)
        {
            /*
            FACTORY METHOD  
            creational grubununa ait, aynı arayüzü kullanan nesnelerin üretiminden sorumlu tasarım desenidir. uluslar arası standartlarda en sık kullanılan tasarım desenlerindendir. 
